![docker image](https://github.com/nomad-hzb/hzb-pvcomb-image/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/nomad-hzb/hzb-pvcomb-image.git
    cd hzb-pvcomb-image
    ```
    ...
    ```sh
    curl-L -o hzb-pvcomb-image.zip "https://github.com/nomad-hzb/hzb-pvcomb-image/archive/main.zip"
    unzip hzb-pvcomb-image.zip
    cd hzb-pvcomb-image
    ```
...
your `docker-compose.yaml` with `ghcr.io/nomad-hzb/hzb-pvcomb-image:main` for the services
...
```
docker pull ghcr.io/nomad-hzb/hzb-pvcomb-image/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/nomad-hzb/hzb-pvcomb-image/manifests/main": unauthorized`
